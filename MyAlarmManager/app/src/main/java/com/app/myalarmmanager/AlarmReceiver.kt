package com.app.myalarmmanager
...
class AlarmReceiver : BroadcastReceiver() {
    ...
    fun setRepeatingAlarm(context: Context, type: String, time: String, message: String) {
        ...
        /*pembeda dimana dia repeat adalah ID-nya serta INTERVAL_DAY
        * khusus android 12, parameter terakhir diisi dengan FLAG_IMMUTABLE, tidak dengan 0*/

package com.app.mydeepnavigation
...
import com.app.mydeepnavigation.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun showNotification(context: Context, title: String, message: String, notifId: Int) {
        ...
        val pendingIntent = TaskStackBuilder.create(this)
            .addParentStack(DetailActivity::class.java)
            .addNextIntent(notifDetailIntent)
            /*khusus user android 12, gunakan FLAG_IMMUTABLE, dibawahnya menggunakan FLAG_UPDATE_CURRENT*/

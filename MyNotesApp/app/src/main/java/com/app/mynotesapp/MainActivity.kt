...
class MainActivity : AppCompatActivity() {
    ...
    /*cara retrieve data dari activity note*/
            ...
            when (result.resultCode) {
                ...
                NoteAddUpdateActivity.RESULT_UPDATE -> {
                    val note =
                        result.data?.getParcelableExtra<Note>(NoteAddUpdateActivity.EXTRA_NOTE) as Note
                    val position =
                        result.data?.getIntExtra(NoteAddUpdateActivity.EXTRA_NOTE, 0) as Int
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /*proses ambil dan menjaga data*/
        if (savedInstanceState == null) {
            loadNotesAsync()
        } else {
            /*jika ada perubahan state layar*/
